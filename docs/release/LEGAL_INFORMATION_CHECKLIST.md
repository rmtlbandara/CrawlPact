...
| Governing jurisdiction                | _(not published — removed 2026-08-04)_                                                                                      | Terms of service §21 "Governing law" removed entirely rather than left with a stale or invented value; see `docs/trust/TRUST_AND_LEGAL_CONFIGURATION.md` "Governing jurisdiction removed" and RISK-029 |
