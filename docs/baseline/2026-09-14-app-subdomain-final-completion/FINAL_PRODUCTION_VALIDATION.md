...
| Real physical authenticator round trip                    | **OWNER-OBSERVED — NOT PERFORMED** | `PHASE_4_STAGE_C_EVIDENCE.md` §5 — this session has no physical device                                                                                                              |
| Google sign-in/sign-up                                    | Not re-tested this pass            | Previously OWNER-OBSERVED confirmed working on both environments, 2026-09-07 (`docs/status/CURRENT_STATE.md`) — unaffected by any change in this pass (no Google-auth code touched) |
