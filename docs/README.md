...
| [`docs/security/RESPONSIBLE_DISCLOSURE_PROCESS.md`](security/RESPONSIBLE_DISCLOSURE_PROCESS.md)                                                                                                                                                                                                | Internal process behind `/security` and `security.txt` | Security       | current-authoritative |
...
| [`docs/trust/TRUST_AND_LEGAL_CONFIGURATION.md`](trust/TRUST_AND_LEGAL_CONFIGURATION.md)                                                                                                                                                                                                        | Approved legal/contact facts and what was omitted      | Legal/business | current-authoritative |
| [`docs/trust/LEGAL_AND_TRUST_SURFACE_INVENTORY.md`](trust/LEGAL_AND_TRUST_SURFACE_INVENTORY.md)                                                                                                                                                                                                | Every public legal/privacy/security/contact surface    | Everyone       | current-authoritative |
| [`docs/privacy/DATA_CATEGORY_AND_PURPOSE_INVENTORY.md`](privacy/DATA_CATEGORY_AND_PURPOSE_INVENTORY.md), [`docs/privacy/PRIVACY_REQUEST_PROCESS.md`](privacy/PRIVACY_REQUEST_PROCESS.md)                                                                                                       | Data inventory and privacy-request handling            | Legal/business | current-authoritative |
