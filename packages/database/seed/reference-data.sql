...
INSERT OR IGNORE INTO crawlers (
  ...
  ('crw_google_extended', 'op_google', 'Google-Extended', 'Google-Extended', 'training',
   ...
   'https://developers.google.com/search/docs/crawling-indexing/google-common-crawlers', 'active', '2026-01-01', '2026-07-30', NULL),
  ...
  ('crw_amzn_searchbot', 'op_amazon', 'Amzn-SearchBot', 'Amzn-SearchBot', 'search',
   'Used to improve search experiences in Amazon products and services (e.g. Alexa-eligible content). Amazon''s own documentation states it does not crawl content for generative AI model training.',
   'https://developer.amazon.com/amazonbot', 'active', '2026-07-30', '2026-07-30', NULL),
  ('crw_amzn_user', 'op_amazon', 'Amzn-User', 'Amzn-User', 'user_triggered',
   'Supports user actions, such as responding to Alexa queries that require up-to-date information. Amazon''s own documentation states it does not crawl content for generative AI model training.',
   'https://developer.amazon.com/amazonbot', 'active', '2026-07-30', '2026-07-30', NULL),
